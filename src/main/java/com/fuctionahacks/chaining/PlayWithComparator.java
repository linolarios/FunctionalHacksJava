...
public class PlayWithComparator {
    ...
    public static void main(String[] args) {
        ...
        Person james = new Person("James", 78);
        ...
        System.out.println("Mary > John " + (comparatorPersonReversed.compare(mary, john) > 0));
        System.out.println("John > James " + (comparatorPersonReversed.compare(john, james) > 0));
        System.out.println("Linda > John " + (comparatorPersonReversed.compare(linda, john) > 0));
    }
}
